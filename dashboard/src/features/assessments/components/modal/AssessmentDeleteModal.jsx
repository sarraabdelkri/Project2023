...
const AssessmentDeleteModal = ({ element, assessment, onDelete, openNow, onClose }) => {
    ...
    return (
        <Modal element={element} openNow={openNow} onClose={() => onClose()}>
            ...
            >
                <Trash size={22} className="mr-2" /> Deleting assessment {assessment.name}
            </Dialog.Title>
            <div className="mt-2">
                <p className="text-sm text-darker-t">
                    The assessment {assessment.name} will be permanently deleted.
                </p>
                <p className="text-sm text-darker-t">
