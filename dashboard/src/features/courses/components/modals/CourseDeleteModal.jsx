...
const CourseDeleteModal = ({ element, course, onDelete, openNow, onClose }) => {
    ...
    return (
        <Modal element={element} openNow={openNow} onClose={() => onClose()}>
            ...
            >
                <Trash size={22} className="mr-2" /> Deleting course {course.name}
            </Dialog.Title>
            <div className="mt-2">
                <p className="text-sm text-darker-t">
                    The course {course.name} will be permanently deleted.
                </p>
                <p className="text-sm text-darker-t">
